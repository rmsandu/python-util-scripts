...
def encode_xml(filename, patient_id, patient_name, patient_dob,  df_ct_mapping, df_segmentations_paths_xml):
    """
    ...
    for segmentation in root.iter('Segmentation'):
        ...
        # todo: find the path index in the df_xml
        # todo: relate the index back to the df_segmentation_series so
        ...
        for el in segmentation:
            if el.tag == 'SeriesUID':
                el.text = series_instance_uid  # todo: change to identified series
