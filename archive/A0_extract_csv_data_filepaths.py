...
ap.add_argument("-f", "--input_excel_file", required=True, help="input excel file patients info")

args = vars(ap.parse_args())
input_dir = args["input_dir"]
input_csv = args['input_excel_file']
...
df["Ablation_IR_Date"] = df["Ablation_IR_Date"].map(lambda x: x[6:len(x)])
